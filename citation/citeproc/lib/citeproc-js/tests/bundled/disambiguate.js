...
doh.register("std.disambiguate", [
    ...
    function(){
        var test = new StdRhinoTest("disambiguate_YearSuffixMacroSameYearExplicit");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
        var test = new StdRhinoTest("disambiguate_LastOnlyFailWithByCite");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
        var test = new StdRhinoTest("disambiguate_ByCiteTwoAuthorsSameCite");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("disambiguate_AndreaEg1a");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("disambiguate_SetsOfNames");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("disambiguate_AndreaEg1b");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("disambiguate_FailWithYearSuffix");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("disambiguate_YearSuffixMacroSameYearImplicit");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("disambiguate_DisambiguationHang");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
