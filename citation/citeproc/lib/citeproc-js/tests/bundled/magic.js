...
doh.register("std.magic", [
    ...
    function(){
        var test = new StdRhinoTest("magic_TermCapitalizationWithPrefix");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("magic_NumberRangeEnglish");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("magic_StripPeriodsWithTextCase");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("magic_SuppressYearIfMatchesCollectionNumber");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("magic_SectionVariable");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("magic_TextRangeEnglish");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("magic_TextRangeFrench");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("magic_NumberRangeFrench");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
