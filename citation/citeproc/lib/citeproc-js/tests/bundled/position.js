...
doh.register("std.position", [
    ...
    function(){
        var test = new StdRhinoTest("position_IbidInText");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("position_IbidWithMultipleSoloCitesInBackref");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("position_IbidSeparateCiteSameNote");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
