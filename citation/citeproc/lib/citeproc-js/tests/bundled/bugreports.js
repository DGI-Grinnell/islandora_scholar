...
doh.register("std.bugreports", [
    ...
    function(){
        var test = new StdRhinoTest("bugreports_NoTransliterationWithBookSection");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("bugreports_DelimitersOnLocator");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("bugreports_RandomItalics");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("bugreports_DelimiterBug");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
    ...
    function(){
        var test = new StdRhinoTest("bugreports_CitationSortsWithEtAl");
        doh.assertEqual(test.result, test.run());
    }, 
    function(){
